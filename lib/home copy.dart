...
import 'package:file_picker/file_picker.dart'; // Importation pour le PDF
...
class _HomeState extends State<Home> {
  ...
  // --- BOUTON DE TRADUCTION SANS ICÔNE ---
      ...
      child: Container(
        ...
        child: _isLoading
            ...
            : const Row(
                ...
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text("Traduire", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
                ],
              ),
      ),
    );
